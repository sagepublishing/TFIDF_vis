...
class Config():
    # Name the dataset
    set_name = 'Continuity in education'
    ...
    perplexity = 20 # recommendation is 5-7% of dataset size.
    learning_rate = 50

    # Visualisation settings
    # when choosing colours for clusters, which years of data would you like to average over? (better to avoid recent years since new articles have no citations)
    av_years = [2014, 2015] # set to 'years' if unsure!
